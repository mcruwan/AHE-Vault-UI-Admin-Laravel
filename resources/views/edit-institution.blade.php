                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    <form id="update-logo" class="form" action="#">
                                        <!--begin::Image input-->
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <ul
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4 pt-0 active" data-bs-toggle="tab"
                                        href="#kt_ecommerce_add_product_general">General</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary pb-4 pt-0" data-bs-toggle="tab"
                                            ...
                                            <div class="card-body pt-0">
                                                <form id="update-categories" class="form" action="#">
                                                    <div class="row mb-6 align-items-center">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <span
                                                                class="col-form-label fw-semibold fs-6 text-gray-500">Total
                                                                Score</span>
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <form id="update-institutional-information" class="form" action="#">
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            <div class="row mb-6">
                                <!--begin::Label-->
