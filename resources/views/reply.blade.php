                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 justify-content-between mb-8">
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            <!--begin::Heading-->
                                            <h2 class="fw-semibold me-3 my-1">Trip Reminder. Thank you for flying with us!
                                            </h2>
                                            <!--begin::Heading-->
                                            <!--begin::Badges-->
                                    ...
                                    <div data-kt-inbox-message="message_wrapper">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="pe-5">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap gap-1">
                                                        <a href="{{ url('#') }}"
                                                            class="fw-bold text-gray-900 text-hover-primary">Emma Smith</a>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <!--begin::Date-->
                                                <span class="fw-semibold text-muted text-end me-3">21 Feb 2024, 9:23
                                                    pm</span>
                                                <!--end::Date-->
                                                <div class="d-flex">
                                                    <!--begin::Star-->
                                        ...
                                        <div class="collapse fade show" data-kt-inbox-message="message">
                                            <div class="py-5">
                                                <p>Hi Bob,</p>
                                                <p>With resrpect, i must disagree with Mr.Zinsser. We all know the most part
                                                    of important part of any article is the title.Without a compelleing
                                                    title, your reader won't even get to the first sentence.After the title,
                                                    however, the first few sentences of your article are certainly the most
                                                    important part.</p>
                                        ...
                                        <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="pe-5">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap gap-1">
                                                        <a href="{{ url('#') }}"
                                                            class="fw-bold text-gray-900 text-hover-primary">Max Smith</a>
                                                        <i class="ki-outline ki-abstract-8 fs-7 text-success mx-3"></i>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <!--begin::Date-->
                                                <span class="fw-semibold text-muted text-end me-3">25 Jul 2024, 10:30
                                                    am</span>
                                                <!--end::Date-->
                                                <div class="d-flex">
                                                    <!--begin::Star-->
                                        ...
                                        <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="pe-5">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap gap-1">
                                                        <a href="{{ url('#') }}"
                                                            class="fw-bold text-gray-900 text-hover-primary">Sean Bean</a>
                                                        <i class="ki-outline ki-abstract-8 fs-7 text-success mx-3"></i>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <!--begin::Date-->
                                                <span class="fw-semibold text-muted text-end me-3">05 May 2024, 5:20
                                                    pm</span>
                                                <!--end::Date-->
                                                <div class="d-flex">
                                                    <!--begin::Star-->
