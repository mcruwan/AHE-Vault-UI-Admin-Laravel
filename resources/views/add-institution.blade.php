                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                            ...
                                                            <div class="row">
                                                                <div class="fv-row">
                                                                    <select name="country" required
                                                                        ...
                                                                        <option data-kt-flag="flags/aruba.svg"
                                                                            value="AW">
                                                                            Aruba</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/benin.svg"
                                                                            value="BJ">
                                                                            Benin</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/chad.svg"
                                                                            value="TD">
                                                                            Chad</option>
                                                                        <option data-kt-flag="flags/chile.svg"
                                                                            value="CL">
                                                                            Chile</option>
                                                                        <option data-kt-flag="flags/china.svg"
                                                                            value="CN">
                                                                            China</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/cuba.svg"
                                                                            value="CU">
                                                                            Cuba</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/egypt.svg"
                                                                            value="EG">
                                                                            Egypt</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/fiji.svg"
                                                                            value="FJ">
                                                                            Fiji</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/gabon.svg"
                                                                            value="GA">
                                                                            Gabon</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/ghana.svg"
                                                                            value="GH">
                                                                            Ghana</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/guam.svg"
                                                                            value="GU">
                                                                            Guam</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/haiti.svg"
                                                                            value="HT">
                                                                            Haiti</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/india.svg"
                                                                            value="IN">
                                                                            India</option>
                                                                        <option data-kt-flag="flags/indonesia.svg"
                                                                            value="ID">Indonesia</option>
                                                                        <option data-kt-flag="flags/iran.svg"
                                                                            value="IR">
                                                                            Iran, Islamic Republic of</option>
                                                                        <option data-kt-flag="flags/iraq.svg"
                                                                            value="IQ">
                                                                            Iraq</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/italy.svg"
                                                                            value="IT">
                                                                            Italy</option>
                                                                        <option data-kt-flag="flags/jamaica.svg"
                                                                            value="JM">Jamaica</option>
                                                                        <option data-kt-flag="flags/japan.svg"
                                                                            value="JP">
                                                                            Japan</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/kenya.svg"
                                                                            value="KE">
                                                                            Kenya</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/laos.svg"
                                                                            value="LA">
                                                                        ...
                                                                        <option data-kt-flag="flags/libya.svg"
                                                                            value="LY">
                                                                            Libya</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/macao.svg"
                                                                            value="MO">
                                                                            Macao</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/mali.svg"
                                                                            value="ML">
                                                                            Mali</option>
                                                                        <option data-kt-flag="flags/malta.svg"
                                                                            value="MT">
                                                                            Malta</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/nauru.svg"
                                                                            value="NR">
                                                                            Nauru</option>
                                                                        <option data-kt-flag="flags/nepal.svg"
                                                                            value="NP">
                                                                            Nepal</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/niger.svg"
                                                                            value="NE">
                                                                            Niger</option>
                                                                        <option data-kt-flag="flags/nigeria.svg"
                                                                            value="NG">Nigeria</option>
                                                                        <option data-kt-flag="flags/niue.svg"
                                                                            value="NU">
                                                                            Niue</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/oman.svg"
                                                                            value="OM">
                                                                            Oman</option>
                                                                        <option data-kt-flag="flags/pakistan.svg"
                                                                            value="PK">Pakistan</option>
                                                                        <option data-kt-flag="flags/palau.svg"
                                                                            value="PW">
                                                                            Palau</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/peru.svg"
                                                                            value="PE">
                                                                            Peru</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/qatar.svg"
                                                                            value="QA">
                                                                            Qatar</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/samoa.svg"
                                                                            value="WS">
                                                                            Samoa</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/spain.svg"
                                                                            value="ES">
                                                                            Spain</option>
                                                                        <option data-kt-flag="flags/sri-lanka.svg"
                                                                            value="LK">Sri Lanka</option>
                                                                        <option data-kt-flag="flags/sudan.svg"
                                                                            value="SD">
                                                                            Sudan</option>
                                                                        ...
                                                                        <option data-kt-flag="flags/syria.svg"
                                                                            value="SY">
                                                                        ...
                                                                        <option data-kt-flag="flags/togo.svg"
                                                                            value="TG">
                                                                            Togo</option>
                                                                        <option data-kt-flag="flags/tokelau.svg"
                                                                            value="TK">Tokelau</option>
                                                                        <option data-kt-flag="flags/tonga.svg"
                                                                            value="TO">
                                                                            Tonga</option>
                                                                        <option
                                                                        ...
                                                                        <option data-kt-flag="flags/venezuela.svg"
                                                                            value="VE">Venezuela, Bolivarian Republic
                                                                            of
                                                                        </option>
                                                                        ...
                                                                        <option data-kt-flag="flags/yemen.svg"
                                                                            value="YE">
                                                                            Yemen</option>
                                                            ...
                                                            <div class="row">
                                                                <div class="fv-row">
                                                                    <input type="url" name="fname"
                                                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                                        placeholder="University Website Link" required />
                                                                </div>
                                                            </div>
                                                            <!--end::Row-->
                                                        </div>
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label
                                                            class="col-lg-4 col-form-label required fw-semibold fs-6">Google
