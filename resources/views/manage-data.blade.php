                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!--begin::Thumbnail-->
                                                <a href="{{ url('edit-data') }}" class="symbol symbol-50px">
                                                    <span class="symbol-label"
                                                        style="background-image:url(assets/media/features-logos/vue-vuetify.png);"></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Sunway University
                                                    </a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('view-data') }}" class="menu-link px-3">View</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('edit-data') }}" class="menu-link px-3">Edit</a>
                                                </div>
                                            </div>
                                            <!--end::Menu-->
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Krirk
                                                        University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">UCSI University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Taylor's University
                                                    </a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Infrastructure
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Asia Metropolitan
                                                        University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Telkom University
                                                    </a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Universitas Ciputra
                                                        Surabaya </a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Manila Central
                                                        University </a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">SEGi University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Duy Tan
                                                        University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">City University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ url('edit-data') }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                        data-kt-ecommerce-product-filter="product_name">Silliman
                                                        University</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
